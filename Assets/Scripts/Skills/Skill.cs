...
public class Skill : NetworkBehaviour
{
    ...
    [ClientRpc]
    private void RpcOnUse(int skillIndex, GameObject unitGo, GameObject targetGo)
    {
    ...
    [ClientRpc]
    private void RpcOnCastComplete(int skillIndex)
    {
        _skills[skillIndex].OnCastComplete();
    }

    [ClientRpc]
    private void RpcOnCooldownComplete(int skillIndex)
    {
